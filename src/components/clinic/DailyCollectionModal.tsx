...
export const DailyCollectionModal: React.FC<DailyCollectionModalProps> = ({
  ...
  const filteredItems = items.filter((item) => {
    ...
    if (searchTerm.trim()) {
      ...
      const matchPatient = item.patient_name.toLowerCase().includes(q) || item.patient_phone.includes(q);
  ...
  const filteredTotal = filteredItems.reduce(
    (sum, item) => (item.status !== 'CANCELLED' ? sum + item.fee : sum),
    0
  );
  ...
  return (
    ...
    >
      <div className="space-y-5 print:p-0">
        {/* 1. Date & Action Bar */}
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 p-3.5 bg-slate-50 border border-[#E2E8F0] rounded-xl">
          <div className="flex items-center gap-3">
            ...
            <input
              ...
              className="text-xs font-mono font-medium px-3 py-1.5 bg-white border border-[#CBD5E1] rounded-lg text-[#172B3A] focus:outline-none focus:ring-2 focus:ring-[#0F4C5C]/20 focus:border-[#0F4C5C]"
            />
            <Button
              variant="ghost"
              size="sm"
          ...
          <div className="flex items-center gap-2 self-end sm:self-auto print:hidden">
            <div className="inline-flex rounded-lg border border-[#CBD5E1] p-0.5 bg-white">
              <button
                type="button"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
          ...
          <div className="p-4 bg-white border border-[#E2E8F0] rounded-xl relative overflow-hidden">
            <div className="flex items-center justify-between mb-1.5">
              ...
              <div className="w-7 h-7 rounded-lg bg-[#0F4C5C]/10 text-[#0F4C5C] flex items-center justify-center font-bold">
                {symbol}
              </div>
            </div>
            <div className="text-2xl sm:text-3xl font-extrabold text-[#172B3A] font-mono tracking-tight">
              {symbol}
            ...
            <div className="text-[11px] text-[#64748B] mt-1 flex items-center gap-1">
              <span className="font-semibold text-[#0F4C5C]">{data?.total_appointments_count || 0} total</span>
              <span>•</span>
          ...
          <div className="p-4 bg-white border border-[#E2E8F0] rounded-xl">
            ...
            <div className="text-2xl sm:text-3xl font-extrabold text-[#0F4C5C] font-mono tracking-tight">
              {symbol}
          ...
          <div className="p-4 bg-white border border-[#E2E8F0] rounded-xl">
            <div className="flex items-center justify-between mb-1.5">
              ...
              <div className="w-7 h-7 rounded-lg bg-slate-100 text-[#0F4C5C] flex items-center justify-center font-bold">
        ...
        {activeViewTab === 'itemized' && (
          <div className="p-3 bg-slate-50 border border-[#E2E8F0] rounded-xl flex flex-wrap items-center justify-between gap-3 text-xs">
            <div className="flex items-center gap-2 flex-1 min-w-[200px]">
              ...
              <input
                ...
                className="w-full bg-white border border-[#CBD5E1] rounded-lg px-2.5 py-1 text-xs text-[#172B3A] placeholder-[#94A3B8] focus:outline-none focus:ring-1 focus:ring-[#0F4C5C]"
              />
            </div>
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <select
                ...
                className="bg-white border border-[#CBD5E1] rounded-lg px-2.5 py-1 text-xs text-[#172B3A] focus:outline-none focus:ring-1 focus:ring-[#0F4C5C]"
              >
          ...
          <div className="border border-[#E2E8F0] rounded-xl overflow-hidden bg-white shadow-xs">
            {filteredItems.length === 0 ? (
              <div className="py-12 px-4 text-center">
                <div className="w-10 h-10 rounded-full bg-slate-100 text-[#64748B] flex items-center justify-center mx-auto mb-2">
                  ...
                  <tfoot>
                    <tr className="bg-slate-50 font-bold border-t-2 border-[#E2E8F0] text-[#172B3A]">
                      <td colSpan={5} className="py-3.5 px-4 text-right uppercase tracking-wider text-[11px] text-[#64748B]">
                        Filtered Realized Collection Total ({filteredItems.filter((i) => i.status !== 'CANCELLED').length} active services):
                      </td>
