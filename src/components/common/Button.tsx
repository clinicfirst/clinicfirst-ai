...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles =
    'inline-flex items-center justify-center font-medium transition-all duration-200 ease-out cursor-pointer select-none rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0F4C5C]/30 focus:ring-offset-1 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:transform-none disabled:active:scale-100 whitespace-nowrap active:scale-[0.98]';
  ...
  const variantStyles = {
    ...
    outline:
      'bg-transparent text-[#0F4C5C] hover:bg-[#0F4C5C]/5 border border-[#0F4C5C] motion-safe:hover:-translate-y-[1px]',
    ghost:
