...
export const ClinicLogin: React.FC<ClinicLoginProps> = ({
  ...
  const handleRoleSelect = (role: 'admin' | 'staff' | 'platform') => {
            ...
            <div className="bg-white border border-[#E2E8F0] rounded-3xl p-6 sm:p-8 shadow-xl shadow-[#083B4A]/6 relative">
                    ...
                    <button
                      ...
                      className={`flex flex-col items-center justify-center py-2 px-1 rounded-lg text-xs font-semibold transition-all cursor-pointer ${
                        selectedRole === 'platform'
                          ? 'bg-[#083B4A] text-white shadow-xs border border-[#083B4A]'
                          : 'text-[#64748B] hover:text-[#172B3A]'
                      }`}
                    >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="pt-2">
                  ...
                  >
                    {selectedRole === 'platform' ? 'Sign In to Master Platform' : 'Sign In to Clinic Portal'}
                  </Button>
                </div>
              </form>
