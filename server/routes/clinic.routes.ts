...
clinicRouter.get(
  ...
  (req: AuthenticatedRequest, res: Response) => {
    ...
    const allAppointments = db.getAppointments(clinicId, { date: today });
    ...
    const allCalls = db.getCalls(clinicId);
    ...
    const rawAllCalls = db.getCalls(clinicId);
...
clinicRouter.get(
  ...
  (req: AuthenticatedRequest, res: Response) => {
    ...
    const patients = db.getPatients(clinicId, search);
...
clinicRouter.get(
  ...
  (req: AuthenticatedRequest, res: Response) => {
    const clinicId = getAuthClinicId(req);
    const calls = db.getCalls(clinicId);
